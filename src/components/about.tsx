        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
              At P.K.Jewellers Pvt Ltd, we believe that every piece of jewelry tells a
              story. Since our inception, we have been dedicated to creating
              exquisite designs that blend traditional craftsmanship with modern
              aesthetics.
            </p>
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Our master artisans pour their heart and soul into every creation,
              ensuring that each gem and every gram of gold meets the highest
            ...
            <div className="grid grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  100% Hallmarked gold and certified diamonds.
                </p>
              </div>
              <div>
                <h4 className="font-serif text-xl mb-2">Custom Design</h4>
                <p className="text-sm text-muted-foreground">
                  Bespoke jewelry designed just for you.
                </p>
              </div>
            </div>
